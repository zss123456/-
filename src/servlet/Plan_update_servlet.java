...
@WebServlet("/plan_update_servlet")
public class Plan_update_servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		int oldId=(int)session.getAttribute("id");
		...
		if(!dao.Plan_dao.isInsert(a)){
			out.print("nok");
		}
		else{
	    int n=0;
	    n=c.upd(a, oldId,oldTime);
	    if(n==1)
	    	out.print("ok");
	    else
	    	out.print("on-ok");
